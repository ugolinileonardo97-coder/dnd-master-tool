...
import { batchOneMonsters } from "./monsters/batchOneMonsters";
import { batchTwoMonsters } from "./monsters/batchTwoMonsters";
import { getMonsterAbilityScores } from "../utils/monsterStats";
import {
  buildPlayableMonsterActions,
  inferMonsterAlignment,
...
const monsterGroups = [
  ...
  { biome: "batch-one", monsters: batchOneMonsters },
  { biome: "batch-two", monsters: batchTwoMonsters },
];
...
export const biomeMonsters = removeDuplicatesByName(
  ...
  ...monster,
  alignment: monster.alignment || inferMonsterAlignment(monster),
  abilityScores: getMonsterAbilityScores(monster),
  technicalActions: buildPlayableMonsterActions(monster),
}));
